...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  pressSearchByButton(String seaarchTypeStr, bool isNameButtonSelectedB,
      bool isCityButtonSelectedB, bool isTypeButtonSelectedB) {
    searchType = seaarchTypeStr;
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              //search by name - city - type - clear btn
              SizedBox(
                height: 48,
                ...
                child: ListView(
                  ...
                  children: [
                    MaterialButton(
                      ...
                      color: isNameButtonSelected ? Colors.blue : Colors.grey,
